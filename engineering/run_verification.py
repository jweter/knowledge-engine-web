...
def main() -> int:
    ...
    parser.add_argument("--lane", action="append", default=[], help="Lane id to run; repeatable. Defaults to all.")
    ...
    for lane in selected:
        ...
        for step in lane["steps"]:
            ...
            if result.returncode:
                print(f"lane {lane['id']} FAILED with exit code {result.returncode}", file=sys.stderr)
