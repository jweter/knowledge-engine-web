...
listen_host="${OLLAMA_HOST:-0.0.0.0:11434}"
...
# own CLI probes/pull at loopback. Preserve the configured listen port by
# default; operators may override the complete client destination explicitly.
